...
use spl_governance::tools::spl_token::inline_spl_token;
...
impl GovernanceProgramTest {
    ...
    pub async fn with_mint_tokens_transaction(
        ...
        let mut instruction = spl_token_2022::instruction::mint_to(
            &inline_spl_token::id(),
            &governed_mint_cookie.address,
            &token_account_keypair.pubkey(),
            &proposal_cookie.account.governance,
    ...
    pub async fn with_transfer_tokens_transaction(
        ...
        #[allow(deprecated)]
        let mut instruction = spl_token_2022::instruction::transfer(
            &inline_spl_token::id(),
