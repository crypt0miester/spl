...
async fn test_revoke_community_tokens() {
    ...
    // Act
    governance_test
        .revoke_community_tokens(&realm_cookie, &token_owner_record_cookie, false)
        .await
        .unwrap();
...
async fn test_revoke_council_tokens() {
    ...
    // Act
    governance_test
        .revoke_council_tokens(&realm_cookie, &token_owner_record_cookie, false)
        .await
        .unwrap();
...
#[tokio::test]
async fn test_revoke_community_2022_tokens() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_new().await;
    ...
    // Act
    governance_test
        .revoke_community_tokens(&realm_cookie, &token_owner_record_cookie, true)
        .await
        .unwrap();
...
#[tokio::test]
async fn test_revoke_council_2022_tokens() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_new().await;
    ...
    // Act
    governance_test
        .revoke_council_tokens(&realm_cookie, &token_owner_record_cookie, true)
        .await
        .unwrap();
...
#[tokio::test]
async fn test_revoke_own_council_2022_tokens() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_new().await;
...
#[tokio::test]
async fn test_revoke_own_council_2022_tokens_with_owner_must_sign_error() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_new().await;
...
#[tokio::test]
async fn test_revoke_community_2022_tokens_with_cannot_revoke_liquid_token_error() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_new().await;
...
#[tokio::test]
async fn test_revoke_community_2022_tokens_with_cannot_revoke_dormant_token_error() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_new().await;

    let mut realm_cookie = governance_test.with_realm_token_2022().await;
...
#[tokio::test]
async fn test_revoke_council_2022_tokens_with_mint_authority_must_sign_error() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_new().await;
...
#[tokio::test]
async fn test_revoke_council_2022_tokens_with_invalid_revoke_authority_error() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_new().await;
...
#[tokio::test]
async fn test_revoke_council_2022_tokens_with_invalid_token_holding_error() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_new().await;
...
#[tokio::test]
async fn test_revoke_council_2022_tokens_with_other_realm_config_account_error() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_new().await;
    ...
    // Try use other Realm config
    let realm_cookie2 = governance_test.with_realm_token_2022().await;
...
#[tokio::test]
async fn test_revoke_council_2022_tokens_with_invalid_realm_config_account_address_error() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_new().await;
...
#[tokio::test]
async fn test_revoke_council_2022_tokens_with_token_owner_record_for_different_mint_error() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_new().await;
...
#[tokio::test]
async fn test_revoke_council_2022_tokens_with_too_large_amount_error() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_new().await;
...
#[tokio::test]
async fn test_revoke_council_2022_tokens_with_partial_revoke_amount() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_new().await;
...
#[tokio::test]
async fn test_revoke_council_2022_tokens_with_community_mint_error() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_new().await;
...
#[tokio::test]
async fn test_revoke_council_2022_tokens_with_not_matching_mint_and_authority_error() {
    // Arrange
    let mut governance_test = GovernanceProgramTest::start_new().await;
